...
const Portfolio = () => {
    ...
    const portfolios = [
        ...
        },
        {
            id: 2, 
            src: Calculator,
            github:"https://github.com/abhishek-475/calculato",
            // href:"",
        },
        {
            id: 3, 
            src: Project,
            github:"https://github.com/abhishek-475/project-management",
            // href:"",
        }
    ]
              ...
              {portfolios.map(({ id, src, href, github }) => (
                <div key={id}  className="shadow-md shadow-gray-600 rounded-lg">
                  ...
                  <div   className="flex items-center justify-center">
                    <button onClick={() => openLinkInNewTab(href)} 
                      className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105" >
                      Demo
                    </button>
                    
                    <button onClick={() => {openLinkInNewTab(github)}}  
                      className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
                      Code
                    </button>
